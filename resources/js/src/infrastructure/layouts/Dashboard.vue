...
<template>
    <div class="flex flex-col h-screen bg-sky-200 md:px-4 md:py-1">
        <div class="w-full bg-indigo-500 p-2 md:rounded-md flex">
            <div ref="sideMenuRef" class="relative flex flex-col w-full">
                ...
                <span class="bg-white rounded-md p-1 whitespace-nowrap flex items-center gap-1">
                    <FontAwesomeIcon :icon="faJedi" class="text-indigo-500" />
                    <span class="text-indigo-500 tracking-wide font-semibold">RECSA</span>
                </span>
                <div v-if="sideMenu" class="rounded-sm bg-indigo-500 absolute lg:fixed p-1 w-[70vw] sm:w-[30vw] top-full -left-2 border border-indigo-500 bg-sky-200">
